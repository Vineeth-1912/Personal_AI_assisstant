...
# $env:GROQ_API_KEY="Add_your_api_key"
...
def main():
    ...
    if not st.session_state.messages:
        st.info("WELCOME: Use Start Voice input or text input and start conversation")

    st.markdown("---")
    st.markdown(
        """
        <div style = "text-align: center">
        <p> Powered by GROQ and STREAMLIT * Copyright: VineethGagan</p>
        </div>
        """,
